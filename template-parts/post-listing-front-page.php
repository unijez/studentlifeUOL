	...
	<div class="item-text">
	    ...
	    <a href="<?php the_permalink();?>">
	    		<?php default_image('post-intro-image'); ?>
					<?php if((get_post_format(get_the_ID()) == "video") && (video_length(get_field('yt_video_id'))) != null): ?><span class="time-stamp"> &#9656;  <?php echo video_length(get_field('yt_video_id')); ?></span> <?php endif; ?>
	    </a>
		</div>
